...
module.exports = [
...

  {
    ...
    path: '/exercises',
    options: {
      description: 'Add or update all exercise (used in course seeder).',
      tags: ['api'],
      validate: {
        payload: Joi.object({
          exercise: Joi.object(),
...

  {
    ...
    options: {
      description: 'Mark the completion of an exercise by id.',
      tags: ['api'],
      auth: { strategy: 'jwt' },
      validate: {
        params: Joi.object({
  ...
  },
  {
    ...
    path: '/exercises/{exerciseId}/complete',
    options: {
      description: 'Undo the completion of an exercise by id.',
      tags: ['api'],
      auth: { strategy: 'jwt' },
      validate: {
        params: Joi.object({
  ...
  },
  {
    ...
    options: {
      description: 'Get all completed exercises of an authenticated user',
      tags: ['api'],
      auth: { strategy: 'jwt' },
      handler: async (request) => {
        const { exercisesService } = request.services();
