...
module.exports = [
  ...
  },
  {
    ...
    path: '/courses/{courseId}',
    options: {
      description: 'Update course by id by an authorised user',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
        scope: getRouteScope('team'),
  ...
  },
  {
    ...
    options: {
      description: 'Create a new course (used in course seeder)',
      tags: ['api'],
      validate: {
        payload: Joi.object({
  ...
  },
  {
    ...
    options: {
      description: 'Mark the completion of a course by id.',
      tags: ['api'],
      auth: { strategy: 'jwt' },
      validate: {
        params: Joi.object({
      ...
      handler: async (request) => {
        const { coursesService } = request.services();
        return coursesService.markCourseComplete(
  ...
  },
  {
    ...
    path: '/courses/{courseId}/complete',
    options: {
      description: 'Undo the completion of a course by id.',
      tags: ['api'],
      auth: { strategy: 'jwt' },
      validate: {
        params: Joi.object({
  ...
  },
  {
    ...
    options: {
      description: 'Get all completed courses for an authenticated user.',
      tags: ['api'],
      auth: { strategy: 'jwt' },
      handler: async (request) => {
        const { coursesService } = request.services();
        return coursesService.getCourseComplete(request.auth.credentials.id);
      },
    },
  },
];
