...
module.exports = [
  {
    ...
    path: '/pathways',
    options: {
      description: 'Get all available pathways',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        const { pathwayService } = request.services();
        return pathwayService.markPathwayComplete(
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        const { pathwayService } = request.services();
        return pathwayService.removePathwayComplete(
          request.auth.credentials.id,
          request.params.pathwayId
        );
      },
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        const { pathwayService } = request.services();
        return pathwayService.getPathwayComplete(request.auth.credentials.id);
      },
    },
  },
];
