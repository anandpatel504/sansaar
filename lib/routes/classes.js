...
module.exports = [
  {
    ...
    options: {
      description:
        'Get a list of all classes. If start date is not defined it gives list of classes in future from now.',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
      },
  ...
  },
  {
    ...
    options: {
      description:
        'Get a list of all classes user is yet to register to. Use filters to get specific types of classes.',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
        mode: 'required',
  ...
  },
  {
    ...
    path: '/classes',
    options: {
      description: 'Creates a class and returns the object of created class',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
      },
  ...
  },
  {
    ...
    path: '/classes/{classId}',
    options: {
      description: 'Updates a class and returns the classes object as response',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
  ...
  },
  {
    ...
    options: {
      description: 'Get four random classes for Meraki users.',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
        mode: 'optional',
  ...
  },
  {
    ...
    path: '/classes/{classId}',
    options: {
      description: 'Delete a class by class id (Dashboard Admin only)',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
        scope: getRouteScope('classAdmin'),
