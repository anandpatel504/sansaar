...
module.exports = [
  ...
  },
  {
    ...
    options: {
      description:
        'Gets a list of all classes a particular user (get by user id) registered to ( Meant for dashboard admin )',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
  ...
  },
  {
    ...
    options: {
      description: 'Register a authenticated user to a class by id',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
      },
  ...
  },
  {
    ...
    options: {
      description: 'Cancel registration to a class of an authenticated user by id',
      tags: ['api'],
      auth: {
        strategy: 'jwt',
      },
